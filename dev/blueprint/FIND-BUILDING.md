...
walk me through how I would find blueprints for a big building online for free. I am currently trying to understand how these buildings are build as I am an architect studnet wanting to understand more interior design once the main architecture is constructed. specifically want to know how entrances are made and how rooms connect to each other. How some rooms are for comfort and other rooms of for staff and praticallity could you tell me where I could find these blueprints

I am specifically looking for startup open office spaces where I want to work. specifically this one Located in: Canary Wharf
Address: 39th Floor, One, Canada Square, Canary Wharf Estate, London E14 5AB
Phone: 020 3668 3600
Hours: Open 24 hours
could you help me plan out a way to find this blueprint for me use the deep research online. and ensure to document are how to do it. I am doing work for this business want to try and optimise their space. The documents focus on planning permission public records focusing on floor plans over the general construction/building usage. You should ensure that the floor plans are details and have all the context then need neccessary for each venue. Save in a new directory in building-scanner/{building-slug}/ in this directory store all associated pdfs for the floor plan for each floor. Furthermore include a BUILDING.md which is a short summary for what each file represents, where they were downloaded from etc. Then WORKFLOW.md in the same directory for the workflow of how the specific where the agent works, what was good/what was bad and where most info was found. 
